...
## Note
This project has both python notebook file and .py script. Run the code using Google Colab https://colab.research.google.com/. If you are running it locally first install the requirements before running the files (download the requirements using requirement.txt file).
...
## Issues
[![GitHub Issues](https://img.shields.io/github/issues/saadhaxxan/AIPakistan.svg?style=flat&label=Issues&maxAge=2592000)](https://www.github.com/saadhaxxan/Visual-and-EDA-of-Corona-Virus/issues)
